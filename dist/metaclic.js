        ...
        container.length) {
            ...
            if (jQuery("div.Metaclic-data").length) {
                ...
                container.on("click", "a[data-page]", function(e) {
                    ...
                    Array.isArray(tags) || (tags = []), tags.push(tag), _Metaclic.container.data("tags", tags), 
                    loadDataSets();
